...
<body class="color">
  ...
  <div class="navbar-fixed"> 
    <nav class="color ">
      <div class="nav-wrapper">
        ...
        <a href="#!" class="brand-logo amber-text ">Mis Cuentos</a>
        <a href="#" data-target="mobile-demo" class="sidenav-trigger"><i class="material-icons">menu</i></a>
        <ul class="right hide-on-med-and-down ">
          <li><a href="?view=login" class=" amber-text">Iniciar sesión</a></li>
          <li><a href="?view=registro" class=" amber-text">Registrarse</a></li>
        </ul>
      </div>
    </nav> 
  </div>
  ...
  <div id="modal1" class="modal">
    <form id="registrocuento" action="procesos/agregar_cuento.php?redamiscuentos" method="post" class="col s12">
  ...
  <div class="section"></div>
    ...
    ?>
        <div class="row">
          ...
          <div class="f-card col s12 m8 l6 grey darken-4 blue-grey-text text-lighten-5">
            <div class="section"></div>
            <div class="row">
              ...
              <div class="col s12">
                <div class="header">
                  ...
                  <div class="co-name "><a class="blue-grey-text text-lighten-5" href="#"><?php echo $AutorPub['nombre']." ".$AutorPub['apellido'] ?></a></div>
                ...
                <div class="social">
                  <div class="social-buttons">
                    <div class="row center">
                      <div class="col s6">
                        <?php
                        $parentesco = $cuento['parentesco'];
                        $idCu = $cuento['idCu'];
                        $autor = $cuento['autor'];
                        $titulo = $cuento['titulo'];
                        $contenido = $cuento['contenido'];
                         ?>
                        <a class='modal-trigger blue-grey-text text-lighten-5' href='actualizar_cuento.php?idCu=<?php echo $idCu ?>'><i class='material-icons blue-grey-text text-lighten-5'>edit</i>Editar</a>
                         
                      </div>
                      <div class="col s6">
                        <a href="procesos/eliminar_cuento.php?idUs=<?php echo $cuento['idUs'] ?>&idCu=<?php echo $cuento['idCu'] ?>" class="blue-grey-text text-lighten-5"><i class="material-icons blue-grey-text text-lighten-5">delete</i>Eliminar</a>
                      </div>
                    </div>                  
                  </div>
                </div>
